<template>
    <div class="clsAbout">
        ...
        <div class="clsContent">
            <div id="Left" class="clsLeft">
                <div class="clsline1">Hi, I am <br> Pradeep</div>
                <div class="clsline2">I am a
                    <span class="clsline2-content">
                        <div class="Typewriter" data-testid="typewriter-wrapper">
                            <span class="Typewriter__wrapper">{{ currentTypedText   }}</span><span class="Typewriter__cursor">|</span>
                        </div>
                    </span>
                </div>
                <div class="clsline3">As a full-stack web developer with a passion for blockchain and finance, I leverage my diverse expertise to craft innovative solutions. With a background in mentorship and multiple project experiences, I bring versatility and a commitment to excellence to every endeavor. Continuously seeking growth and learning, I aim to make a positive impact in the digital realm through my creative contributions.!</div>
                <a href="https://drive.google.com/file/d/1MPejGYqmpv0t-HdyUIXTUFAuSk7bn8S8/view?usp=drive_link" target="display" class="clsViewbtn">View My Resume</a>
            </div>
            <div id="Right" class="clsReight">
                <img src="../assets/Images/portfolio_1.png" alt="hero-image" class="clsImg">
            </div>
        </div>
    </div>
</template>
...
export default {
  data() {
    return {
      texts: ["Full Stack Developer.", "Blockchain Enthusiast.", "Freelancer.", "Mentor.", "Techie."],
      currentTextIndex: 0,
      typedText: "",
      currentIndex: 0,
      typingSpeed: 100,
  ...
  methods: {
    typeNextCharacter() {
      ...
      if (this.currentIndex < currentText.length) {
        ...
        setTimeout(this.resetAndMoveToNextText, this.loopDelay);
      }
    },
    resetAndMoveToNextText() {
      this.currentIndex = 0;
      this.typedText = "";
